...
function cellCreator(c, timeOut) {
  ...
  for (var i = 0; i < c; i++) {
    ...
    if (timeOut == 0) {<html><head><title>Chapter 13 - String examples</title></head>
<body>
<H3> Changing the formatting with the <I>bold</I> method</H3>
<script language="JavaScript">
var str= "I am a happy string!"
document.write ("The string is \"" + str + "After bolding, it becomes "+ str.bold())
</script>
<H3>Getting the length of a string with the <I>length</I> property</H3>
<script language="JavaScript">
var str= "I am a string!"
document.write ("The string is \"" + str +"And it\'s length is " + str.length)
</script>
<H3>Looking for a string within a string <I>indexOf</I> property</H3>
<script language="JavaScript">
...
<H3>Getting a specified part of a string with the <I>substr</I> method</H3>
<script language="JavaScript">
var str = "A bard in Avon is worth two of George Bush"
document.write ("The string is '" + str + "' and <I>substr(2,4)</I> returns “+str.substr(2,4) + "'
